...
// Strutture dati di base per conversazioni, messaggi, commenti, utenti e gruppi.
// Queste strutture sono usate in tutto il backend per rappresentare le entità principali.
// Ad esempio, Message viene usato sia negli handler API che nelle funzioni database.
